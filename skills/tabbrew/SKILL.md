---
name: tabbrew
description: Translate a Chrome tab snapshot + a natural-language goal into an executable TabBrew Script. Use this for any TabBrew Script task — generating, debugging, or extending. Trigger on any natural-language tab-management goal (organize, clean up, categorize, pin, move, close, group).
---
